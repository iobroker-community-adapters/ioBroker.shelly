...
(async () => {
  const __mfHostInit = await __mfImport("./hostInit-BKQUmJDV.js");
  await __mfHostInit.__tla;
  const { initHost } = __mfHostInit;
  await initHost();
  const __mfPendingShares = await __mfImport("./pendingShares-BpWGiNMr.js").catch(() => undefined);
...
})().then(() => __mfImport("./index-J56w9y67.js"));
