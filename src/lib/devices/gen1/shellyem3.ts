 ...
 */
const shellyem3: DeviceDefinition = {
    'Relay0.Switch': {
        coap: {
            coap_publish: '1101',
    ...
    'Emeter0.ChannelName': {
        coap: {
            ...
            http_publish_funct: async (value, self) =>
                value ? await shellyHelper.setChannelName(self, 'Emeter0', JSON.parse(value).name) : undefined,
    ...
    'Emeter1.ChannelName': {
        coap: {
            ...
            http_publish_funct: async (value, self) =>
                value ? await shellyHelper.setChannelName(self, 'Emeter1', JSON.parse(value).name) : undefined,
    ...
    'Emeter2.ChannelName': {
        coap: {
            ...
            http_publish_funct: async (value, self) =>
                value ? await shellyHelper.setChannelName(self, 'Emeter2', JSON.parse(value).name) : undefined,
