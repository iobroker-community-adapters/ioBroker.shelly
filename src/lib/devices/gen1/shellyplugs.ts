 ...
 */
const shellyplugs: DeviceDefinition = {
    'Relay0.Switch': {
        coap: {
            coap_publish: '1101',
    ...
    led_power_disable: {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => (value ? JSON.parse(value).led_power_disable : undefined),
            http_cmd: '/settings',
            http_cmd_funct: value => ({ led_power_disable: value }),
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: value => (value ? JSON.parse(value).led_power_disable : undefined),
