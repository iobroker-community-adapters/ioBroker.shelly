 ...
 */
const shellybulb: DeviceDefinition = {
    'Sys.deviceMode': {
        coap: {
    ...
    'lights.Switch': {
        coap: {
            ...
            http_cmd: '/color/0',
            http_cmd_funct: value => (value === true ? { turn: 'on' } : { turn: 'off' }),
        },
        mqtt: {
    ...
    'lights.rgbw': {
        coap: {
            http_publish: '/color/0',
            http_publish_funct: async (value, self) => (await shellyHelper.getRGBW(self)) || undefined,
            http_cmd: '/color/0',
            http_cmd_funct: value => shellyHelper.getColorsFromRGBW(value),
        },
        mqtt: {
            mqtt_publish: 'shellies/<mqttprefix>/color/0/status',
            mqtt_publish_funct: async (value, self) => (await shellyHelper.getRGBW(self)) || undefined,
            mqtt_cmd: 'shellies/<mqttprefix>/color/0/set',
    ...
    'lights.hue': {
        coap: {
            http_publish: '/color/0',
            http_publish_funct: async (value, self) => (await shellyHelper.getHsvFromRgb(self)).hue || undefined,
            http_cmd: '/color/0',
            http_cmd_funct: async (value, self) => await shellyHelper.getColorsFromHue(self),
        },
        mqtt: {
            mqtt_publish: 'shellies/<mqttprefix>/color/0/status',
            mqtt_publish_funct: async (value, self) => (await shellyHelper.getHsvFromRgb(self)).hue || undefined,
            mqtt_cmd: 'shellies/<mqttprefix>/color/0/set',
    ...
    'lights.saturation': {
        coap: {
            http_publish: '/color/0',
            http_publish_funct: async (value, self) => (await shellyHelper.getHsvFromRgb(self)).saturation || undefined,
            http_cmd: '/color/0',
            http_cmd_funct: (value, self) => shellyHelper.getColorsFromHue(self),
        },
        mqtt: {
            mqtt_publish: 'shellies/<mqttprefix>/color/0/status',
            mqtt_publish_funct: async (value, self) => (await shellyHelper.getHsvFromRgb(self)).saturation || undefined,
            mqtt_cmd: 'shellies/<mqttprefix>/color/0/set',
            mqtt_cmd_funct: async (value, self) => JSON.stringify(await shellyHelper.getColorsFromHue(self)),
        },
        common: {
