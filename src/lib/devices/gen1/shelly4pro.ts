 ...
 */
const shelly4pro: DeviceDefinition = {
    'Relay0.Switch': {
        coap: {
            coap_publish: '112',
    ...
    */
    ...
    'Relay1.Energy': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => {
                return value ? Math.round((JSON.parse(value).meters[1].total / 60) * 100) / 100 : undefined;
            },
        },
        mqtt: {
    ...
    */
    'Relay2.AutoTimerOff': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => (value ? JSON.parse(value).relays[2].auto_off : undefined),
            http_cmd: '/settings/relay/2',
            http_cmd_funct: value => ({ auto_off: value }),
        },
        mqtt: {
    ...
    'Relay2.AutoTimerOn': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => (value ? JSON.parse(value).relays[2].auto_on : undefined),
            http_cmd: '/settings/relay/2',
            http_cmd_funct: value => ({ auto_on: value }),
        },
        mqtt: {
    ...
    'Relay2.ButtonType': {
        coap: {
            http_publish: '/settings',
            http_cmd: '/settings/relay/2',
            http_publish_funct: value => (value ? JSON.parse(value).relays[2].btn_type : undefined),
            http_cmd_funct: value => ({ btn_type: value }),
        },
        mqtt: {
            http_publish: '/settings',
    ...
    'Relay2.ButtonReverse': {
        coap: {
            http_publish: '/settings',
            http_cmd: '/settings/relay/2',
            http_publish_funct: value => (value ? JSON.parse(value).relays[2].btn_reverse : undefined),
            http_cmd_funct: value => ({ btn_reverse: value }),
        },
        mqtt: {
            http_publish: '/settings',
    ...
    'Relay2.Energy': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => {
                return value ? Math.round((JSON.parse(value).meters[2].total / 60) * 100) / 100 : undefined;
            },
        },
        mqtt: {
    ...
    'Relay3.ChannelName': {
        coap: {
            ...
            http_publish_funct: async (value, self) => value ? await shellyHelper.setChannelName(self, 'Relay3', JSON.parse(value).name) : undefined,
    ...
    */
    'Relay3.AutoTimerOff': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => (value ? JSON.parse(value).relays[3].auto_off : undefined),
            http_cmd: '/settings/relay/3',
            http_cmd_funct: value => ({ auto_off: value }),
        },
        mqtt: {
    ...
    'Relay3.AutoTimerOn': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => (value ? JSON.parse(value).relays[3].auto_on : undefined),
            http_cmd: '/settings/relay/3',
            http_cmd_funct: value => ({ auto_on: value }),
        },
        mqtt: {
    ...
    'Relay3.ButtonType': {
        coap: {
            http_publish: '/settings',
            http_cmd: '/settings/relay/3',
            http_publish_funct: value => (value ? JSON.parse(value).relays[3].btn_type : undefined),
            http_cmd_funct: value => ({ btn_type: value }),
        },
        mqtt: {
            http_publish: '/settings',
    ...
    'Relay3.ButtonReverse': {
        coap: {
            http_publish: '/settings',
            http_cmd: '/settings/relay/3',
            http_publish_funct: value => (value ? JSON.parse(value).relays[3].btn_reverse : undefined),
            http_cmd_funct: value => ({ btn_reverse: value }),
        },
        mqtt: {
            http_publish: '/settings',
    ...
    'Relay3.Energy': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => {
                return value ? Math.round((JSON.parse(value).meters[3].total / 60) * 100) / 100 : undefined;
            },
        },
        mqtt: {
