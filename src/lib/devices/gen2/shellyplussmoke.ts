 ...
 *
 * https://shelly-api-docs.shelly.cloud/gen2/Devices/Gen2/ShellyPlusSmoke
 */
const shellyplussmoke: DeviceDefinition = {
    'Smoke0.ChannelName': {
        device_mode: 'switch',
        mqtt: {
...
shellyHelperGen2.addDevicePower(shellyplussmoke, 0, false);

export { shellyplussmoke };
