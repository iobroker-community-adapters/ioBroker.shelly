...
Der Adapter verbindet sich dann mit dem bestehenden Broker und abonniert die notwendigen Shelly-Topics (`shellies/#`, `+/events/#`, `+/status/#`, `+/rpc`, `+/online`, `+/debug/#` sowie die Ein-Ordner-Varianten `+/+/events/#`, `+/+/status/#`, `+/+/rpc`, `+/+/online`, `+/+/debug/#`).
