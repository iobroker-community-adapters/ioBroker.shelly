...
Der Adapter verbindet sich dann mit dem bestehenden Broker und abonniert die notwendigen Shelly-Topics (`shellies/#`, `shelly/+/events/#`, `shelly/+/status/#`, `shelly/+/rpc`, `shelly/+/online`, `shelly/+/debug/#`).
