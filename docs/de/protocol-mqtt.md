...
- Der Adapter abonniert `shellies/#` (Gen1) sowie `shelly/+/events/#`, `shelly/+/status/#`, `shelly/+/rpc`, `shelly/+/online`, `shelly/+/debug/#` (Gen2+) zur automatischen Geräteerkennung und für Live-Statusänderungen
