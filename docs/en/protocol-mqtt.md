...
- The adapter subscribes to `shellies/#` (Gen1) and `shelly/+/events/#`, `shelly/+/status/#`, `shelly/+/rpc`, `shelly/+/online`, `shelly/+/debug/#` (Gen2+) to auto-discover devices and receive live status changes
