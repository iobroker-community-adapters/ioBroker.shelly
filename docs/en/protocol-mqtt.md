...
- The adapter subscribes to `shellies/#` (Gen1) and `+/events/#`, `+/rpc`, `+/online`, `+/debug/#`, `+/+/events/#`, `+/+/rpc`, `+/+/online`, `+/+/debug/#` (Gen2+) to auto-discover devices (supports prefixes like `shellyplus1-abc123` and `shelly/shellyplus1-abc123`)
