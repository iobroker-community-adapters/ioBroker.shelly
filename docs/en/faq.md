...
The adapter will then connect to your existing broker and subscribe to the required Shelly topics (`shellies/#`, `+/events/#`, `+/rpc`, `+/online`, `+/debug/#`, `+/+/events/#`, `+/+/rpc`, `+/+/online`, `+/+/debug/#`).
