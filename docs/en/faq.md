...
The adapter will then connect to your existing broker and subscribe to the required Shelly topics (`shellies/#`, `+/events/#`, `+/status/#`, `+/rpc`, `+/online`, `+/debug/#`, and one-folder variants like `+/+/events/#`, `+/+/status/#`, `+/+/rpc`, `+/+/online`, `+/+/debug/#`).
