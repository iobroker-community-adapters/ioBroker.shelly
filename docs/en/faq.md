...
The adapter will then connect to your existing broker and subscribe to the required Shelly topics (`shellies/#`, `shelly/+/events/#`, `shelly/+/status/#`, `shelly/+/rpc`, `shelly/+/online`, `shelly/+/debug/#`).
