...
const defaultsgen100 = require('./devices/default').defaultsgen100; //poweredByShelly
...
function getDeviceByClass(deviceClass, protocol, mode) {
    ...
    switch (getDeviceGen(deviceClass)) {
        case 100:
            device = clone(Object.assign(Object.assign({}, defaultsgen100), devices[deviceClass]));
            break;
        case 4:
...
function getAllDeviceDefinitions() {
    return Object.entries(devices).reduce((o, [deviceClass, device]) => {
        switch (getDeviceGen(deviceClass)) {
            case 100:
                o[deviceClass] = clone(Object.assign(Object.assign({}, defaultsgen100), device));
                break;
            case 4:
