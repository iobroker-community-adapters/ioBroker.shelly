...
const shellypluspmmini = require('./devices/gen2/shellypluspmmini').shellypluspmmini;
...
const deviceKnowledgeBase = {
    ...
    shellypluspmmini: 'https://shelly-api-docs.shelly.cloud/gen2/Devices/ShellyPlusPMMini',
