...
function getDeviceByClass(deviceClass, protocol, mode) {
    ...
    switch (getDeviceGen(deviceClass) ) {
        case 3: device = clone(Object.assign(devices[deviceClass], defaultsgen3)); break;
        case 2: device = clone(Object.assign(devices[deviceClass], defaultsgen2)); break;
        default: device = clone(Object.assign(devices[deviceClass], defaultsgen1));
    }
...
function getAllDeviceDefinitions() {
    return Object.entries(devices).reduce((o, [deviceClass, device]) => {
        switch (getDeviceGen(deviceClass) ) {
            case 3: o[deviceClass] = clone(Object.assign(device, defaultsgen3)); break;
            case 2: o[deviceClass] = clone(Object.assign(device, defaultsgen2)); break;
            default: o[deviceClass] = clone(Object.assign(device, defaultsgen1));
        }
        return o;
    }, {});
}
