...
// Gen 4
const shelly0110dimg4 = require('./devices/gen4/shelly0110dimg4').shelly0110dimg4;
...
const shellyemg4 = require('./devices/gen4/shellyemg4').shellyemg4;
...
const shellypresence = require('./devices/gen4/shellypresence').shellypresence;
const shellypstripg4 = require('./devices/gen4/shellypstripg4').shellypstripg4;

// Pwowered by Shelly
const cury = require('./devices/poweredbyshelly/cury').cury;
const hiluxds8 = require('./devices/poweredbyshelly/hiluxds8').hiluxds8;
