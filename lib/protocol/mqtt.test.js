...
describe('Test external MQTT topic handling', function () {
    ...
    it('identifies Gen2 status topic prefixes for live switch updates', function () {
        const server = new MQTTServerExternal(createAdapter(), {}, {});
    ...
    it('accepts single and one-folder stored Mqtt.topicPrefix values', async function () {
