...
class MQTTServerExternal extends BaseServer {
    ...
    listen() {
        ...
        this.mqttClientConnection.on('message', async (topic, payload) => {
            ...
            this.adapter.log.debug(`[MQTT External] Received packet: topic=${topic}, payload=${payloadString}`);
            ...
            if (!devicePrefix) {
                this.adapter.log.debug(`[MQTT External] Ignoring packet without Shelly device prefix: topic=${topic}`);
                return;
            }
