...
class MQTTServerExternal extends BaseServer {
    ...
    async _handleInitSrcMessage(topic, payload) {
        try {
            ...
            const { prefix: existingPrefix, client } = this._findClientByEquivalentPrefix(srcDevice);
    ...
    _findKnownGen1PrefixByTopic(topic) {
        const knownPrefixes = Object.keys(this.deviceClients).sort((a, b) => b.length - a.length);
