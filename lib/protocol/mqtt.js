...
class ExternalMQTTDeviceClient extends MQTTClient {
    ...
    async initialize() {
        ...
        await this.initIPFromState();
        this.adapter.log.info(`[DEBUG] ip=${this.getIP()}, online=${this.isOnline()}, deviceId=${this.getDeviceId()}`);
        await this.adapter.deviceStatusUpdate(this.getDeviceId(), true);
        this.adapter.log.info(`[DEBUG] after deviceStatusUpdate: online=${this.isOnline()}`);
