...
class BaseClient {
    ...
    async requestAsync(url) {
        ...
        if (this.adapter.config.saveHttpResponses) {
            this.adapter.mkdirAsync(this.adapter.namespace, 'httpDebug');
            this.adapter.mkdirAsync(this.adapter.namespace, httpDebugDir);
        }
        ...
        return new Promise((resolve, reject) => {
            ...
            if (this.getDeviceGen() === 1) {
                ...
                axios(
                    ...
                    if (this.adapter.config.saveHttpResponses) {
                        this.adapter.log.debug(`[requestAsync] Saving HTTP debug file to ${httpDebugFilePath}`);
