                    ...
                    if (dp && dp.state) {
                        ...
                        try {
                            ...
                            if (dp[this.type] && dp[this.type].http_publish_funct) {
                                value = isAsync(dp[this.type].http_publish_funct)
                                    ? await dp[this.type].http_publish_funct(value, this)
                                    : dp[this.type].http_publish_funct(value, this);
                            }
                        ...
                        if (state[this.type] && state[this.type].http_cmd && !hasTypeCmd) {
                            ...
                            controlFunction = async value => {
                                if (this.isOnline()) {
                                    ...
                                    if (state[this.type]?.http_cmd_funct) {
                                        try {
                                            publishValue = isAsync(state[this.type].http_cmd_funct)
                                                ? await state[this.type].http_cmd_funct(value, this)
                                                : state[this.type].http_cmd_funct(value, this);
                                            this.adapter.log.debug(
