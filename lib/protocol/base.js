...
class BaseClient {
    ...
    async requestAsync(url) {
        ...
        return new Promise((resolve, reject) => {
            ...
            } else if (this.getDeviceGen() === 2 || this.getDeviceGen() === 3) {
                            ...
                            controlFunction = async (value) => {
                                if (this.isOnline()) {
                                    ...
                                    try {
                                        ...
                                        } else if (this.getDeviceGen() === 3 ) {
                                            // Not supported
                                            this.adapter.log.error(`[http controlFunction] Error in function state.${this.type}.http_cmd of state ${fullStateId} for ${this.getLogInfo()}: Not supported for Gen 3 devices`);
                                        }
