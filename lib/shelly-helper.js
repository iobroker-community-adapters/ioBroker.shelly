...
function addSwitchToGen2Device(deviceObj, switchId, hasPowerMetering) {
    ...
    deviceObj[`Relay${switchId}.InputMode`] = {
        mqtt: {
            ...
            http_publish_funct: async (value) => { return value ? JSON.parse(value).in_mode : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Relay${switchId}.InitialState`] = {
        mqtt: {
            http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).initial_state : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Relay${switchId}.AutoTimerOn`] = {
        mqtt: {
            http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).auto_on : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Relay${switchId}.AutoTimerOnDelay`] = {
        mqtt: {
            http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).auto_on_delay : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Relay${switchId}.AutoTimerOff`] = {
        mqtt: {
            http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).auto_off : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Relay${switchId}.AutoTimerOffDelay`] = {
        mqtt: {
            http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).auto_off_delay : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    if (hasPowerMetering) {
        ...
        */
        ...
        deviceObj[`Relay${switchId}.LimitPower`] = {
            mqtt: {
                http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
                http_publish_funct: async (value) => { return value ? JSON.parse(value).power_limit : undefined; },
                mqtt_cmd: '<mqttprefix>/rpc',
        ...
        deviceObj[`Relay${switchId}.LimitCurrent`] = {
            mqtt: {
                http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
                http_publish_funct: async (value) => { return value ? JSON.parse(value).current_limit : undefined; },
                mqtt_cmd: '<mqttprefix>/rpc',
        ...
        deviceObj[`Relay${switchId}.LimitVoltage`] = {
            mqtt: {
                http_publish: `/rpc/Switch.GetConfig?id=${switchId}`,
                http_publish_funct: async (value) => { return value ? JSON.parse(value).voltage_limit : undefined; },
                mqtt_cmd: '<mqttprefix>/rpc',
...
function addInputToGen2Device(deviceObj, inputId) {
    ...
    deviceObj[`Input${inputId}.InputType`] = {
        mqtt: {
            http_publish: `/rpc/Input.GetConfig?id=${inputId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).type : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Input${inputId}.InputInverted`] = {
        mqtt: {
            http_publish: `/rpc/Input.GetConfig?id=${inputId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).invert : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
...
function addCoverToGen2Device(deviceObj, coverId) {
    ...
    deviceObj[`Cover${coverId}.Open`] = {
        ...
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: () => { return JSON.stringify({id: 0, src: 'iobroker', method: 'Cover.Open', params: {id: coverId}}); }
        },
        common: {
            'name': 'Open',
            'type': 'boolean',
    ...
    deviceObj[`Cover${coverId}.Stop`] = {
        ...
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: () => { return JSON.stringify({id: 0, src: 'iobroker', method: 'Cover.Stop', params: {id: coverId}}); }
        },
        common: {
            'name': 'Stop',
            'type': 'boolean',
    ...
    deviceObj[`Cover${coverId}.Close`] = {
        ...
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: () => { return JSON.stringify({id: 0, src: 'iobroker', method: 'Cover.Close', params: {id: coverId}}); }
        },
        common: {
            'name': 'Close',
            'type': 'boolean',
    ...
    deviceObj[`Cover${coverId}.Calibrate`] = {
        ...
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: () => { return JSON.stringify({id: 0, src: 'iobroker', method: 'Cover.Calibrate', params: {id: coverId}}); }
        },
        common: {
            'name': 'Calibrate',
            'type': 'boolean',
    ...
    deviceObj[`Cover${coverId}.InputSwap`] = {
        ...
        mqtt: {
            http_publish: `/rpc/Cover.GetConfig?id=${coverId}`,
            http_publish_funct: async (value) => { return value ? JSON.parse(value).swap_inputs : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
