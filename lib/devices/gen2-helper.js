    ...
    deviceObj[`CCT${cctId}.DimStop`] = {
        ...
        common: {
            name: {
                en: 'Dim Stop',
                de: 'Dimmen stoppen',
                ru: 'Остановить затемнение',
                pt: 'Parar de diminuir intensidade',
                nl: 'Dimmen stoppen',
                fr: 'Arrêter le gradation',
                it: 'Ferma la regolazione',
                es: 'Detener la regulación',
                pl: 'Zatrzymaj przyciemnianie',
                uk: 'Зупинити затемнення',
                'zh-cn': '停止调光',
            },
            type: 'boolean',
            role: 'button',
 ...
 * @param {number} curyId
 */
function addCury(deviceObj, curyId) {
    // === Config states ===
    ...
    deviceObj[`Cury${curyId}.BoostTime`] = {
        ...
        common: {
            name: {
                ...
                pt: 'Tempo de reforço',
                nl: 'Boost-tijd',
                fr: "Durée d'amplification",
                it: 'Durata boost',
                es: 'Tiempo de refuerzo',
                pl: 'Czas przyspieszenia',
                uk: 'Час прискорення',
                'zh-cn': '加速时间',
            },
            type: 'number',
    ...
    deviceObj[`Cury${curyId}.AutoHeatingOn`] = {
        ...
        common: {
            name: {
                en: 'Auto heating on',
                de: 'Automatische Heizung ein',
                ru: 'Автоматический обогрев вкл.',
                pt: 'Aquecimento automático ligado',
                nl: 'Automatische verwarming aan',
                fr: 'Chauffage automatique activé',
                it: 'Riscaldamento automatico attivo',
                es: 'Calefacción automática activada',
                pl: 'Automatyczne ogrzewanie włączone',
                uk: 'Автоматичне опалення ввімкнено',
                'zh-cn': '自动加热开启',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.UiBrightness`] = {
        ...
        common: {
            name: {
                ...
                ru: 'Яркость интерфейса',
                pt: 'Brilho da interface',
                nl: 'UI-helderheid',
                fr: "Luminosité de l'interface",
                it: "Luminosità dell'interfaccia",
                es: 'Brillo de la interfaz',
                pl: 'Jasność interfejsu',
                uk: 'Яскравість інтерфейсу',
                'zh-cn': '界面亮度',
            },
            type: 'number',
            role: 'level.brightness',
    ...
    deviceObj[`Cury${curyId}.AmbientEnable`] = {
        ...
        common: {
            name: {
                en: 'Ambient light enabled',
                de: 'Umgebungslicht aktiviert',
                ru: 'Подсветка включена',
                pt: 'Luz ambiente ativada',
                nl: 'Omgevingslicht ingeschakeld',
                fr: 'Éclairage ambiant activé',
                it: 'Luce ambientale attiva',
                es: 'Luz ambiental activada',
                pl: 'Oświetlenie otoczenia włączone',
                uk: 'Підсвічування ввімкнено',
                'zh-cn': '环境灯已启用',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.AmbientUseVialColor`] = {
        ...
        common: {
            name: {
                en: 'Ambient use vial color',
                de: 'Umgebungslicht Flakon-Farbe',
                ru: 'Подсветка использует цвет флакона',
                pt: 'Luz ambiente usa cor do frasco',
                nl: 'Omgevingslicht gebruikt fleskleur',
                fr: 'Lumière ambiante utilise la couleur du flacon',
                it: 'La luce ambientale usa il colore del flacone',
                es: 'La luz ambiental usa el color del frasco',
                pl: 'Oświetlenie używa koloru fiolki',
                uk: 'Підсвічування використовує колір флакона',
                'zh-cn': '环境灯使用瓶颜色',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.AmbientColor`] = {
        ...
        common: {
            name: {
                en: 'Ambient color (RGB)',
                de: 'Umgebungsfarbe (RGB)',
                ru: 'Цвет подсветки (RGB)',
                pt: 'Cor ambiente (RGB)',
                nl: 'Omgevingskleur (RGB)',
                fr: 'Couleur ambiante (RGB)',
                it: 'Colore ambiente (RGB)',
                es: 'Color ambiental (RGB)',
                pl: 'Kolor otoczenia (RGB)',
                uk: 'Колір підсвічування (RGB)',
                'zh-cn': '环境颜色 (RGB)',
            },
            type: 'string',
            role: 'state',
    ...
    deviceObj[`Cury${curyId}.AmbientBrightness`] = {
        ...
        common: {
            name: {
                ...
                ru: 'Яркость подсветки',
                pt: 'Brilho ambiente',
                nl: 'Omgevingshelderheid',
                fr: 'Luminosité ambiante',
                it: 'Luminosità ambiente',
                es: 'Brillo ambiental',
                pl: 'Jasność otoczenia',
                uk: 'Яскравість підсвічування',
                'zh-cn': '环境亮度',
            },
            type: 'number',
            role: 'level.brightness',
    ...
    deviceObj[`Cury${curyId}.InitialStateLeft`] = {
        ...
        common: {
            name: {
                en: 'Initial state left slot',
                de: 'Anfangszustand linker Slot',
                ru: 'Начальное состояние левого слота',
                pt: 'Estado inicial slot esquerdo',
                nl: 'Beginstatus linker slot',
                fr: 'État initial slot gauche',
                it: 'Stato iniziale slot sinistro',
                es: 'Estado inicial ranura izquierda',
                pl: 'Stan początkowy lewy slot',
                uk: 'Початковий стан лівого слота',
                'zh-cn': '左槽初始状态',
            },
            type: 'string',
            role: 'state',
    ...
    deviceObj[`Cury${curyId}.InitialStateRight`] = {
        ...
        common: {
            name: {
                en: 'Initial state right slot',
                de: 'Anfangszustand rechter Slot',
                ru: 'Начальное состояние правого слота',
                pt: 'Estado inicial slot direito',
                nl: 'Beginstatus rechter slot',
                fr: 'État initial slot droit',
                it: 'Stato iniziale slot destro',
                es: 'Estado inicial ranura derecha',
                pl: 'Stan początkowy prawy slot',
                uk: 'Початковий стан правого слота',
                'zh-cn': '右槽初始状态',
            },
            type: 'string',
            role: 'state',
    ...
    deviceObj[`Cury${curyId}.TimerLeftAutoOn`] = {
        ...
        common: {
            name: {
                en: 'Timer left slot auto on',
                de: 'Timer linker Slot automatisch ein',
                ru: 'Таймер левого слота авто вкл.',
                pt: 'Timer slot esquerdo auto ligar',
                nl: 'Timer linker slot automatisch aan',
                fr: 'Minuterie slot gauche auto marche',
                it: 'Timer slot sinistro auto acceso',
                es: 'Temporizador ranura izquierda auto encendido',
                pl: 'Timer lewy slot auto włącz',
                uk: 'Таймер лівого слота авто увімк.',
                'zh-cn': '左槽定时器自动开',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.TimerLeftAutoOnDelay`] = {
        ...
        common: {
            name: {
                en: 'Timer left slot auto on delay',
                de: 'Timer linker Slot automatisch ein Verzögerung',
                ru: 'Таймер левого слота авто вкл. задержка',
                pt: 'Timer slot esquerdo auto ligar atraso',
                nl: 'Timer linker slot automatisch aan vertraging',
                fr: 'Minuterie slot gauche auto marche délai',
                it: 'Timer slot sinistro auto acceso ritardo',
                es: 'Temporizador ranura izquierda auto encendido retraso',
                pl: 'Timer lewy slot auto włącz opóźnienie',
                uk: 'Таймер лівого слота авто увімк. затримка',
                'zh-cn': '左槽定时器自动开延迟',
            },
            type: 'number',
            role: 'level.timer',
    ...
    deviceObj[`Cury${curyId}.TimerLeftAutoOff`] = {
        ...
        common: {
            name: {
                en: 'Timer left slot auto off',
                de: 'Timer linker Slot automatisch aus',
                ru: 'Таймер левого слота авто выкл.',
                pt: 'Timer slot esquerdo auto desligar',
                nl: 'Timer linker slot automatisch uit',
                fr: 'Minuterie slot gauche auto arrêt',
                it: 'Timer slot sinistro auto spento',
                es: 'Temporizador ranura izquierda auto apagado',
                pl: 'Timer lewy slot auto wyłącz',
                uk: 'Таймер лівого слота авто вимк.',
                'zh-cn': '左槽定时器自动关',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.TimerLeftAutoOffDelay`] = {
        ...
        common: {
            name: {
                en: 'Timer left slot auto off delay',
                de: 'Timer linker Slot automatisch aus Verzögerung',
                ru: 'Таймер левого слота авто выкл. задержка',
                pt: 'Timer slot esquerdo auto desligar atraso',
                nl: 'Timer linker slot automatisch uit vertraging',
                fr: 'Minuterie slot gauche auto arrêt délai',
                it: 'Timer slot sinistro auto spento ritardo',
                es: 'Temporizador ranura izquierda auto apagado retraso',
                pl: 'Timer lewy slot auto wyłącz opóźnienie',
                uk: 'Таймер лівого слота авто вимк. затримка',
                'zh-cn': '左槽定时器自动关延迟',
            },
            type: 'number',
            role: 'level.timer',
    ...
    deviceObj[`Cury${curyId}.TimerRightAutoOn`] = {
        ...
        common: {
            name: {
                en: 'Timer right slot auto on',
                de: 'Timer rechter Slot automatisch ein',
                ru: 'Таймер правого слота авто вкл.',
                pt: 'Timer slot direito auto ligar',
                nl: 'Timer rechter slot automatisch aan',
                fr: 'Minuterie slot droit auto marche',
                it: 'Timer slot destro auto acceso',
                es: 'Temporizador ranura derecha auto encendido',
                pl: 'Timer prawy slot auto włącz',
                uk: 'Таймер правого слота авто увімк.',
                'zh-cn': '右槽定时器自动开',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.TimerRightAutoOnDelay`] = {
        ...
        common: {
            name: {
                en: 'Timer right slot auto on delay',
                de: 'Timer rechter Slot automatisch ein Verzögerung',
                ru: 'Таймер правого слота авто вкл. задержка',
                pt: 'Timer slot direito auto ligar atraso',
                nl: 'Timer rechter slot automatisch aan vertraging',
                fr: 'Minuterie slot droit auto marche délai',
                it: 'Timer slot destro auto acceso ritardo',
                es: 'Temporizador ranura derecha auto encendido retraso',
                pl: 'Timer prawy slot auto włącz opóźnienie',
                uk: 'Таймер правого слота авто увімк. затримка',
                'zh-cn': '右槽定时器自动开延迟',
            },
            type: 'number',
            role: 'level.timer',
    ...
    deviceObj[`Cury${curyId}.TimerRightAutoOff`] = {
        ...
        common: {
            name: {
                en: 'Timer right slot auto off',
                de: 'Timer rechter Slot automatisch aus',
                ru: 'Таймер правого слота авто выкл.',
                pt: 'Timer slot direito auto desligar',
                nl: 'Timer rechter slot automatisch uit',
                fr: 'Minuterie slot droit auto arrêt',
                it: 'Timer slot destro auto spento',
                es: 'Temporizador ranura derecha auto apagado',
                pl: 'Timer prawy slot auto wyłącz',
                uk: 'Таймер правого слота авто вимк.',
                'zh-cn': '右槽定时器自动关',
            },
            type: 'boolean',
            role: 'switch.enable',
    ...
    deviceObj[`Cury${curyId}.TimerRightAutoOffDelay`] = {
        ...
        common: {
            name: {
                en: 'Timer right slot auto off delay',
                de: 'Timer rechter Slot automatisch aus Verzögerung',
                ru: 'Таймер правого слота авто выкл. задержка',
                pt: 'Timer slot direito auto desligar atraso',
                nl: 'Timer rechter slot automatisch uit vertraging',
                fr: 'Minuterie slot droit auto arrêt délai',
                it: 'Timer slot destro auto spento ritardo',
                es: 'Temporizador ranura derecha auto apagado retraso',
                pl: 'Timer prawy slot auto wyłącz opóźnienie',
                uk: 'Таймер правого слота авто вимк. затримка',
                'zh-cn': '右槽定时器自动关延迟',
            },
            type: 'number',
            role: 'level.timer',
    ...
    deviceObj[`Cury${curyId}.AwayMode`] = {
        ...
        common: {
            name: {
                en: 'Away mode',
                de: 'Abwesenheitsmodus',
                ru: 'Режим отсутствия',
                pt: 'Modo ausente',
                nl: 'Afwezigheid modus',
                fr: "Mode d'absence",
                it: 'Modalità assenza',
                es: 'Modo ausente',
                pl: 'Tryb nieobecności',
                uk: 'Режим відсутності',
                'zh-cn': '离家模式',
            },
            type: 'boolean',
            role: 'switch',
    ...
    deviceObj[`Cury${curyId}.LeftOn`] = {
        ...
        common: {
            name: {
                en: 'Left slot heating on',
                de: 'Linker Slot Heizung ein',
                ru: 'Обогрев левого слота вкл.',
                pt: 'Aquecimento slot esquerdo ligado',
                nl: 'Linker slot verwarming aan',
                fr: 'Chauffage slot gauche activé',
                it: 'Riscaldamento slot sinistro attivo',
                es: 'Calefacción ranura izquierda activada',
                pl: 'Ogrzewanie lewego slotu włączone',
                uk: 'Обігрів лівого слота увімк.',
                'zh-cn': '左槽加热开',
            },
            type: 'boolean',
            role: 'switch',
    ...
    deviceObj[`Cury${curyId}.LeftIntensity`] = {
        ...
        common: {
            name: {
                en: 'Left slot intensity',
                de: 'Linker Slot Intensität',
                ru: 'Интенсивность левого слота',
                pt: 'Intensidade slot esquerdo',
                nl: 'Linker slot intensiteit',
                fr: 'Intensité slot gauche',
                it: 'Intensità slot sinistro',
                es: 'Intensidad ranura izquierda',
                pl: 'Intensywność lewego slotu',
                uk: 'Інтенсивність лівого слота',
                'zh-cn': '左槽强度',
            },
            type: 'number',
            role: 'level',
    ...
    deviceObj[`Cury${curyId}.LeftBoostStartedAt`] = {
        ...
        common: {
            name: {
                en: 'Left slot boost started at',
                de: 'Linker Slot Boost gestartet um',
                ru: 'Левый слот ускорение начато в',
                pt: 'Boost slot esquerdo iniciado em',
                nl: 'Linker slot boost gestart om',
                fr: 'Boost slot gauche démarré à',
                it: 'Boost slot sinistro avviato alle',
                es: 'Boost ranura izquierda iniciado a las',
                pl: 'Boost lewego slotu rozpoczął się o',
                uk: 'Лівий слот прискорення почалось о',
                'zh-cn': '左槽加速开始时间',
            },
            type: 'number',
            role: 'date',
    ...
    deviceObj[`Cury${curyId}.LeftBoostDuration`] = {
        ...
        common: {
            name: {
                en: 'Left slot boost duration',
                de: 'Linker Slot Boost-Dauer',
                ru: 'Длительность ускорения левого слота',
                pt: 'Duração do boost slot esquerdo',
                nl: 'Linker slot boost duur',
                fr: 'Durée boost slot gauche',
                it: 'Durata boost slot sinistro',
                es: 'Duración boost ranura izquierda',
                pl: 'Czas trwania boostu lewego slotu',
                uk: 'Тривалість прискорення лівого слота',
                'zh-cn': '左槽加速持续时间',
            },
            type: 'number',
            role: 'value',
    ...
    deviceObj[`Cury${curyId}.LeftTimerStartedAt`] = {
        ...
        common: {
            name: {
                en: 'Left slot timer started at',
                de: 'Linker Slot Timer gestartet um',
                ru: 'Таймер левого слота начат в',
                pt: 'Timer slot esquerdo iniciado em',
                nl: 'Linker slot timer gestart om',
                fr: 'Minuterie slot gauche démarrée à',
                it: 'Timer slot sinistro avviato alle',
                es: 'Temporizador ranura izquierda iniciado a las',
                pl: 'Timer lewego slotu rozpoczął się o',
                uk: 'Таймер лівого слота почався о',
                'zh-cn': '左槽定时器开始时间',
            },
            type: 'number',
            role: 'date',
    ...
    deviceObj[`Cury${curyId}.LeftTimerDuration`] = {
        ...
        common: {
            name: {
                en: 'Left slot timer duration',
                de: 'Linker Slot Timer-Dauer',
                ru: 'Длительность таймера левого слота',
                pt: 'Duração do timer slot esquerdo',
                nl: 'Linker slot timer duur',
                fr: 'Durée minuterie slot gauche',
                it: 'Durata timer slot sinistro',
                es: 'Duración temporizador ranura izquierda',
                pl: 'Czas trwania timera lewego slotu',
                uk: 'Тривалість таймера лівого слота',
                'zh-cn': '左槽定时器持续时间',
            },
            type: 'number',
            role: 'value',
    ...
    deviceObj[`Cury${curyId}.LeftVialLevel`] = {
        ...
        common: {
            name: {
                en: 'Left vial liquid level',
                de: 'Linke Flakon Füllstand',
                ru: 'Уровень жидкости левого флакона',
                pt: 'Nível de líquido frasco esquerdo',
                nl: 'Linker flesje vloeistofniveau',
                fr: 'Niveau de liquide flacon gauche',
                it: 'Livello liquido flacone sinistro',
                es: 'Nivel de líquido frasco izquierdo',
                pl: 'Poziom cieczy lewej fiolki',
                uk: 'Рівень рідини лівого флакона',
                'zh-cn': '左瓶液位',
            },
            type: 'number',
            role: 'value',
    ...
    deviceObj[`Cury${curyId}.LeftVialSerial`] = {
        ...
        common: {
            name: {
                en: 'Left vial serial number',
                de: 'Linke Flakon Seriennummer',
                ru: 'Серийный номер левого флакона',
                pt: 'Número de série frasco esquerdo',
                nl: 'Linker flesje serienummer',
                fr: 'Numéro de série flacon gauche',
                it: 'Numero di serie flacone sinistro',
                es: 'Número de serie frasco izquierdo',
                pl: 'Numer seryjny lewej fiolki',
                uk: 'Серійний номер лівого флакона',
                'zh-cn': '左瓶序列号',
            },
            type: 'string',
            role: 'text',
    ...
    deviceObj[`Cury${curyId}.LeftVialName`] = {
        ...
        common: {
            name: {
                en: 'Left vial aroma name',
                de: 'Linke Flakon Aromaname',
                ru: 'Название аромата левого флакона',
                pt: 'Nome do aroma frasco esquerdo',
                nl: 'Linker flesje aromanaam',
                fr: "Nom de l'arôme flacon gauche",
                it: 'Nome aroma flacone sinistro',
                es: 'Nombre del aroma frasco izquierdo',
                pl: 'Nazwa aromatu lewej fiolki',
                uk: 'Назва аромату лівого флакона',
                'zh-cn': '左瓶香氛名称',
            },
            type: 'string',
            role: 'text',
    ...
    deviceObj[`Cury${curyId}.LeftVialFault`] = {
        ...
        common: {
            name: {
                en: 'Left vial fault',
                de: 'Linke Flakon Fehler',
                ru: 'Ошибка левого флакона',
                pt: 'Falha frasco esquerdo',
                nl: 'Linker flesje fout',
                fr: 'Défaut flacon gauche',
                it: 'Errore flacone sinistro',
                es: 'Falla frasco izquierdo',
                pl: 'Błąd lewej fiolki',
                uk: 'Помилка лівого флакона',
                'zh-cn': '左瓶故障',
            },
            type: 'string',
            role: 'state',
    ...
    deviceObj[`Cury${curyId}.RightOn`] = {
        ...
        common: {
            name: {
                en: 'Right slot heating on',
                de: 'Rechter Slot Heizung ein',
                ru: 'Обогрев правого слота вкл.',
                pt: 'Aquecimento slot direito ligado',
                nl: 'Rechter slot verwarming aan',
                fr: 'Chauffage slot droit activé',
                it: 'Riscaldamento slot destro attivo',
                es: 'Calefacción ranura derecha activada',
                pl: 'Ogrzewanie prawego slotu włączone',
                uk: 'Обігрів правого слота увімк.',
                'zh-cn': '右槽加热开',
            },
            type: 'boolean',
            role: 'switch',
    ...
    deviceObj[`Cury${curyId}.RightIntensity`] = {
        ...
        common: {
            name: {
                en: 'Right slot intensity',
                de: 'Rechter Slot Intensität',
                ru: 'Интенсивность правого слота',
                pt: 'Intensidade slot direito',
                nl: 'Rechter slot intensiteit',
                fr: 'Intensité slot droit',
                it: 'Intensità slot destro',
                es: 'Intensidad ranura derecha',
                pl: 'Intensywność prawego slotu',
                uk: 'Інтенсивність правого слота',
                'zh-cn': '右槽强度',
            },
            type: 'number',
            role: 'level',
    ...
    deviceObj[`Cury${curyId}.RightBoostStartedAt`] = {
        ...
        common: {
            name: {
                en: 'Right slot boost started at',
                de: 'Rechter Slot Boost gestartet um',
                ru: 'Правый слот ускорение начато в',
                pt: 'Boost slot direito iniciado em',
                nl: 'Rechter slot boost gestart om',
                fr: 'Boost slot droit démarré à',
                it: 'Boost slot destro avviato alle',
                es: 'Boost ranura derecha iniciado a las',
                pl: 'Boost prawego slotu rozpoczął się o',
                uk: 'Правий слот прискорення почалось о',
                'zh-cn': '右槽加速开始时间',
            },
            type: 'number',
            role: 'date',
    ...
    deviceObj[`Cury${curyId}.RightBoostDuration`] = {
        ...
        common: {
            name: {
                en: 'Right slot boost duration',
                de: 'Rechter Slot Boost-Dauer',
                ru: 'Длительность ускорения правого слота',
                pt: 'Duração do boost slot direito',
                nl: 'Rechter slot boost duur',
                fr: 'Durée boost slot droit',
                it: 'Durata boost slot destro',
                es: 'Duración boost ranura derecha',
                pl: 'Czas trwania boostu prawego slotu',
                uk: 'Тривалість прискорення правого слота',
                'zh-cn': '右槽加速持续时间',
            },
            type: 'number',
            role: 'value',
    ...
    deviceObj[`Cury${curyId}.RightTimerStartedAt`] = {
        ...
        common: {
            name: {
                en: 'Right slot timer started at',
                de: 'Rechter Slot Timer gestartet um',
                ru: 'Таймер правого слота начат в',
                pt: 'Timer slot direito iniciado em',
                nl: 'Rechter slot timer gestart om',
                fr: 'Minuterie slot droit démarrée à',
                it: 'Timer slot destro avviato alle',
                es: 'Temporizador ranura derecha iniciado a las',
                pl: 'Timer prawego slotu rozpoczął się o',
                uk: 'Таймер правого слота почався о',
                'zh-cn': '右槽定时器开始时间',
            },
            type: 'number',
            role: 'date',
    ...
    deviceObj[`Cury${curyId}.RightTimerDuration`] = {
        ...
        common: {
            name: {
                en: 'Right slot timer duration',
                de: 'Rechter Slot Timer-Dauer',
                ru: 'Длительность таймера правого слота',
                pt: 'Duração do timer slot direito',
                nl: 'Rechter slot timer duur',
                fr: 'Durée minuterie slot droit',
                it: 'Durata timer slot destro',
                es: 'Duración temporizador ranura derecha',
                pl: 'Czas trwania timera prawego slotu',
                uk: 'Тривалість таймера правого слота',
                'zh-cn': '右槽定时器持续时间',
            },
            type: 'number',
            role: 'value',
    ...
    deviceObj[`Cury${curyId}.RightVialLevel`] = {
        ...
        common: {
            name: {
                en: 'Right vial liquid level',
                de: 'Rechte Flakon Füllstand',
                ru: 'Уровень жидкости правого флакона',
                pt: 'Nível de líquido frasco direito',
                nl: 'Rechter flesje vloeistofniveau',
                fr: 'Niveau de liquide flacon droit',
                it: 'Livello liquido flacone destro',
                es: 'Nivel de líquido frasco derecho',
                pl: 'Poziom cieczy prawej fiolki',
                uk: 'Рівень рідини правого флакона',
                'zh-cn': '右瓶液位',
            },
            type: 'number',
            role: 'value',
    ...
    deviceObj[`Cury${curyId}.RightVialSerial`] = {
        ...
        common: {
            name: {
                en: 'Right vial serial number',
                de: 'Rechte Flakon Seriennummer',
                ru: 'Серийный номер правого флакона',
                pt: 'Número de série frasco direito',
                nl: 'Rechter flesje serienummer',
                fr: 'Numéro de série flacon droit',
                it: 'Numero di serie flacone destro',
                es: 'Número de serie frasco derecho',
                pl: 'Numer seryjny prawej fiolki',
                uk: 'Серійний номер правого флакона',
                'zh-cn': '右瓶序列号',
            },
            type: 'string',
            role: 'text',
    ...
    deviceObj[`Cury${curyId}.RightVialName`] = {
        ...
        common: {
            name: {
                en: 'Right vial aroma name',
                de: 'Rechte Flakon Aromaname',
                ru: 'Название аромата правого флакона',
                pt: 'Nome do aroma frasco direito',
                nl: 'Rechter flesje aromanaam',
                fr: "Nom de l'arôme flacon droit",
                it: 'Nome aroma flacone destro',
                es: 'Nombre del aroma frasco derecho',
                pl: 'Nazwa aromatu prawej fiolki',
                uk: 'Назва аромату правого флакона',
                'zh-cn': '右瓶香氛名称',
            },
            type: 'string',
            role: 'text',
    ...
    deviceObj[`Cury${curyId}.RightVialFault`] = {
        ...
        common: {
            name: {
                en: 'Right vial fault',
                de: 'Rechte Flakon Fehler',
                ru: 'Ошибка правого флакона',
                pt: 'Falha frasco direito',
                nl: 'Rechter flesje fout',
                fr: 'Défaut flacon droit',
                it: 'Errore flacone destro',
                es: 'Falla frasco derecho',
                pl: 'Błąd prawej fiolki',
                uk: 'Помилка правого флакона',
                'zh-cn': '右瓶故障',
            },
            type: 'string',
            role: 'state',
    ...
    deviceObj[`Cury${curyId}.errors`] = {
        ...
        common: {
            name: {
                en: 'Device errors',
                de: 'Gerätefehler',
                ru: 'Ошибки устройства',
                pt: 'Erros do dispositivo',
                nl: 'Apparaatfouten',
                fr: "Erreurs de l'appareil",
                it: 'Errori del dispositivo',
                es: 'Errores del dispositivo',
                pl: 'Błędy urządzenia',
                uk: 'Помилки пристрою',
                'zh-cn': '设备错误',
            },
    ...
    deviceObj[`Cury${curyId}.LeftBoost`] = {
        ...
        common: {
            name: {
                en: 'Left slot boost',
                de: 'Linker Slot Boost starten',
                ru: 'Запустить ускорение левого слота',
                pt: 'Iniciar boost slot esquerdo',
                nl: 'Linker slot boost starten',
                fr: 'Démarrer boost slot gauche',
                it: 'Avvia boost slot sinistro',
                es: 'Iniciar boost ranura izquierda',
                pl: 'Uruchom boost lewego slotu',
                uk: 'Запустити прискорення лівого слота',
                'zh-cn': '启动左槽加速',
            },
            type: 'boolean',
            role: 'button',
    ...
    deviceObj[`Cury${curyId}.LeftStopBoost`] = {
        ...
        common: {
            name: {
                en: 'Left slot stop boost',
                de: 'Linker Slot Boost stoppen',
                ru: 'Остановить ускорение левого слота',
                pt: 'Parar boost slot esquerdo',
                nl: 'Linker slot boost stoppen',
                fr: 'Arrêter boost slot gauche',
                it: 'Ferma boost slot sinistro',
                es: 'Parar boost ranura izquierda',
                pl: 'Zatrzymaj boost lewego slotu',
                uk: 'Зупинити прискорення лівого слота',
                'zh-cn': '停止左槽加速',
            },
            type: 'boolean',
            role: 'button',
    ...
    deviceObj[`Cury${curyId}.RightBoost`] = {
        ...
        common: {
            name: {
                en: 'Right slot boost',
                de: 'Rechter Slot Boost starten',
                ru: 'Запустить ускорение правого слота',
                pt: 'Iniciar boost slot direito',
                nl: 'Rechter slot boost starten',
                fr: 'Démarrer boost slot droit',
                it: 'Avvia boost slot destro',
                es: 'Iniciar boost ranura derecha',
                pl: 'Uruchom boost prawego slotu',
                uk: 'Запустити прискорення правого слота',
                'zh-cn': '启动右槽加速',
            },
            type: 'boolean',
            role: 'button',
    ...
    deviceObj[`Cury${curyId}.RightStopBoost`] = {
        ...
        common: {
            name: {
                en: 'Right slot stop boost',
                de: 'Rechter Slot Boost stoppen',
                ru: 'Остановить ускорение правого слота',
                pt: 'Parar boost slot direito',
                nl: 'Rechter slot boost stoppen',
                fr: 'Arrêter boost slot droit',
                it: 'Ferma boost slot destro',
                es: 'Parar boost ranura derecha',
                pl: 'Zatrzymaj boost prawego slotu',
                uk: 'Зупинити прискорення правого слота',
                'zh-cn': '停止右槽加速',
            },
            type: 'boolean',
            role: 'button',
