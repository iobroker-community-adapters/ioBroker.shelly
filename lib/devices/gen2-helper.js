...
function addCover(deviceObj, coverId, hasSlat) {
    ...
    deviceObj[`Cover${coverId}.FavoritePos1.GoTo`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: async (value, self) => {
                const pos = await shellyHelper.getFavoritePosition(self, 'Favorites.Cover${coverId}.FavoritePos1.Pos');
                return (pos === undefined) ? undefined : JSON.stringify({
                    id: self.getNextMsgId(),
                    src: 'iobroker',
                    method: 'Cover.GoToPosition',
                    params: { id: coverId, pos: value },
    ...
    deviceObj[`Cover${coverId}.FavoritePos2.GoTo`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: async (value, self) => {
                const pos = await shellyHelper.getFavoritePosition(self, 'Favorites.Cover${coverId}.FavoritePos2.Pos');
                return (pos === undefined) ? undefined : JSON.stringify({
                    id: self.getNextMsgId(),
                    src: 'iobroker',
                    method: 'Cover.GoToPosition',
    ...
    deviceObj[`Cover${coverId}.FavoritePos3.GoTo`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: async (value, self) => {
                const pos = await shellyHelper.getFavoritePosition(self, 'Cover${coverId}.FavoritePos3.Pos.Position1Pos');
                return (pos === undefined) ? undefined : JSON.stringify({
                    id: self.getNextMsgId(),
                    src: 'iobroker',
                    method: 'Cover.GoToPosition',
