...
function addTemperatureSensorToGen2Device(deviceObj, sensorId) {
    ...
    deviceObj[`Temperature${sensorId}.ReportThreshold`] = {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 1, src: 'iobroker', method: 'Temperature.SetConfig', params: { id: sensorId, config: { report_thr_C: value } }}); },
        },
        common: {
            name: {
                en: 'Report threshold',
...
function addHumiditySensorToGen2Device(deviceObj, sensorId) {
    ...
    deviceObj[`Humidity${sensorId}.ReportThreshold`] = {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 1, src: 'iobroker', method: 'Humidity.SetConfig', params: { id: sensorId, config: { report_thr: value } }}); },
        },
        common: {
            name: {
                en: 'Report threshold',
