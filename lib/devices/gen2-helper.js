...
function addEnergyMeterToGen2Device(deviceObj, emId, phases) {
    ...
    deviceObj[`EM${emId}.ChannelName`] = {
        mqtt: {
            ...
            http_publish_funct: async (value, self) => { return value ? await shellyHelper.setChannelName(self, `EM${emId}`, JSON.parse(value).name) : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => { return JSON.stringify({ id: self.getNextMsgId(), src: 'iobroker', method: 'EM.SetConfig', params: { id: emId, config: { name: value }}}); },
        },
        common: {
            name: {
                en: 'Channel name',
    ...
    deviceObj[`EM${emId}.CurrentN`] = {
        mqtt: {
            ...
            mqtt_publish_funct: (value) => { return JSON.parse(value)[`n_current`]; },
        },
        common: {
            name: 'Current N',
            type: 'number',
    ...
    deviceObj[`EM${emId}.TotalCurrent`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/em:${emId}`,
            mqtt_publish_funct: (value) => { return JSON.parse(value)[`total_current`]; },
        },
        common: {
            name: 'Total Current',
            type: 'number',
    ...
    deviceObj[`EM${emId}.TotalActivePower`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/em:${emId}`,
            mqtt_publish_funct: (value) => { return JSON.parse(value)[`total_act_power`]; },
        },
        common: {
    ...
    deviceObj[`EM${emId}.TotalApparentPower`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/em:${emId}`,
            mqtt_publish_funct: (value) => { return JSON.parse(value)[`total_aprt_power`]; },
        },
        common: {
    ...
    for (const phase of phases) {
        ...
        deviceObj[`EM${emId}.Voltage${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/em:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_voltage`]; },
            },
            common: {
                name: {
                    en: 'Voltage',
        ...
        deviceObj[`EM${emId}.Current${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/em:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_current`]; },
            },
            common: {
                name: 'Current',
                type: 'number',
        ...
        deviceObj[`EM${emId}.ActivePower${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/em:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_act_power`]; },
            },
            common: {
                name: 'Power (active)',
                type: 'number',
        ...
        deviceObj[`EM${emId}.ApparentPower${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/em:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_aprt_power`]; },
            },
            common: {
                name: 'Power (apparent)',
                type: 'number',
        ...
        deviceObj[`EM${emId}.PowerFactor${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/em:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_pf`]; },
            },
            common: {
                name: 'Power Factor',
                type: 'number',
...
function addEnergyMeterDataToGen2Device(deviceObj, emId, phases) {
    ...
    deviceObj[`EMData${emId}.TotalActiveEnergy`] = {
        mqtt: {
            ...
            mqtt_publish_funct: (value) => { return JSON.parse(value)[`total_act`]; },
        },
        common: {
    ...
    deviceObj[`EMData${emId}.TotalActiveReturnEnergy`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/emdata:${emId}`,
            mqtt_publish_funct: (value) => { return JSON.parse(value)[`total_act_ret`]; },
        },
        common: {
    ...
    for (const phase of phases) {
        ...
        deviceObj[`EMData${emId}.TotalActiveEnergy${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/emdata:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_total_act_energy`]; },
            },
            common: {
                name: 'Energy (active)',
                type: 'number',
        ...
        deviceObj[`EMData${emId}.TotalActiveReturnEnergy${phaseUp}`] = {
            mqtt: {
                mqtt_publish: `<mqttprefix>/status/emdata:${emId}`,
                mqtt_publish_funct: (value) => { return JSON.parse(value)[`${phase}_total_act_ret_energy`]; },
            },
            common: {
...
module.exports = {
    ...
    addEnergyMeterToGen2Device: addEnergyMeterToGen2Device,
    addEnergyMeterDataToGen2Device: addEnergyMeterDataToGen2Device,
};
