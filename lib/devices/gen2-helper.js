 ...
 * @param deviceObj - The device object where states and commands are added.
 */
// Example MQTT Publish event for Shelly Flood G4 device
// Device: shellyfloodg4 / shellyfloodg4-xxxxxxxxxxxx / shellyfloodg4#xxxxxxxxxxxx#1
// Topic: shellyfloodg4-xxxxxxxxxxxx/events/rpc
// QoS: 1
// Payload:
// {
//     "src": "shellyfloodg4-xxxxxxxxxxxx",
//     "dst": "shellyfloodg4-xxxxxxxxxxxx/events",
//     "method": "NotifyStatus",
//     "params": {
//         "ts": 1758447003.72,
//         "flood:0": {
...
function addFlood(deviceObj, floodId) {
    deviceObj[`Flood${floodId}.alarm`] = {
        ...
        mqtt: {
            ...
            mqtt_publish_funct: value => {
                const valueObj = JSON.parse(value);
                if (valueObj?.method === 'NotifyStatus') {
                    return  valueObj?.params?.alarm
                }
               return undefined;
            },
        },
