...
function addVoltmeterSensor(deviceObj, sensorId) {
    ...
    deviceObj[`Voltmeter${sensorId}.ReportThreshold`] = {
        mqtt: {
            http_publish: `/rpc/Voltemter.GetConfig?id=${sensorId}`,
            http_publish_funct: value => (value ? JSON.parse(value).report_thr : undefined),
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => {
                return JSON.stringify({
 ...
 * @param sensorId
 */
function addAnalogInputSensor(deviceObj, sensorId) {
    deviceObj[`AnalogInput${sensorId}.ChannelName`] = {
        mqtt: {
            http_publish: `/rpc/Input.GetConfig?id=${sensorId}`,
            http_publish_funct: async (value, self) => {
                return value
                    ? await shellyHelper.setChannelName(self, `Humidity${sensorId}`, JSON.parse(value).name)
                    : undefined;
    ...
    deviceObj[`AnalogInput${sensorId}.Range`] = {
        mqtt: {
            http_publish: `/rpc/AnalogInput.GetConfig?id=${sensorId}`,
            http_publish_funct: value => (value ? JSON.parse(value).report_thr : undefined),
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => {
                return JSON.stringify({
    ...
    deviceObj[`AnalogInput${sensorId}.percent`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/input:${sensorId}`,
