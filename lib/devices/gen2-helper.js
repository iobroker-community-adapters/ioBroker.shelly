...
function addSwitchToGen2Device(deviceObj, switchId, hasPowerMetering) {
    ...
    deviceObj[`Relay${switchId}.Switch`] = {
        ...
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 0, src: 'iobroker', method: 'Switch.Set', params: { id: switchId, on: value }}); },
        },
        common: {
            name: {
                en: 'Switch',
    ...
    deviceObj[`Cover${coverId}.Open`] = {
        ...
        mqtt: {
            ...
            mqtt_cmd_funct: async (value, self) => {
                ...
                if (duration > 0) {
                    return JSON.stringify({ id: 0, src: 'iobroker', method: 'Cover.Open', params: { id: coverId, duration: duration }});
                } else {
                    return JSON.stringify({ id: 0, src: 'iobroker', method: 'Cover.Open', params: { id: coverId }});
                }
            },
        },
        common: {
    ...
    deviceObj[`Cover${coverId}.Close`] = {
        ...
        mqtt: {
            ...
            mqtt_cmd_funct: async (value, self) => {
                ...
                if (duration > 0) {
                    return JSON.stringify({ id: 0, src: 'iobroker', method: 'Cover.Close', params: { id: coverId, duration: duration }});
                } else {
                    return JSON.stringify({ id: 0, src: 'iobroker', method: 'Cover.Close', params: { id: coverId }});
                }
            },
        },
        common: {
...
function addTemperatureSensorToGen2Device(deviceObj, sensorId) {
    ...
    deviceObj[`Temperature${sensorId}.ChannelName`] = {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 0, src: 'iobroker', method: 'Temperature.SetConfig', params: { id: sensorId, config: { name: value }}}); },
        },
        common: {
            name: {
                en: 'Channel name',
    ...
    deviceObj[`Temperature${sensorId}.ReportThreshold`] = {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 0, src: 'iobroker', method: 'Temperature.SetConfig', params: { id: sensorId, config: { report_thr_C: value } }}); },
        },
        common: {
            name: {
                en: 'Report threshold',
...
function addHumiditySensorToGen2Device(deviceObj, sensorId) {
    ...
    deviceObj[`Humidity${sensorId}.ChannelName`] = {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 0, src: 'iobroker', method: 'Humidity.SetConfig', params: { id: sensorId, config: { name: value }}}); },
        },
        common: {
            name: {
                en: 'Channel name',
    ...
    deviceObj[`Humidity${sensorId}.ReportThreshold`] = {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 0, src: 'iobroker', method: 'Humidity.SetConfig', params: { id: sensorId, config: { report_thr: value } }}); },
        },
        common: {
            name: {
                en: 'Report threshold',
