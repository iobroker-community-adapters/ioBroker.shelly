 ...
 * @param deviceObj - The device object where states and commands are added.
 */
function addFloodComponent(deviceObj) {
    deviceObj[`alarm`] = {
        mqtt: {
            http_publish: `/rpc/Flood.GetStatus?id=0`,
            http_publish_funct: value => JSON.parse(value).alarm,
        },
        common: {
            name: {
                "en": "alarm",
    ...
    deviceObj[`mute`] = {
        mqtt: {
            http_publish: `/rpc/Flood.GetStatus?id=0`,
            http_publish_funct: value => JSON.parse(value).mute,
        },
        common: {
            name: {
                "en": "mute\n",
    ...
    deviceObj[`errors`] = {
        mqtt: {
            http_publish: `/rpc/Flood.GetStatus?id=0`,
            http_publish_funct: value => JSON.stringify(JSON.parse(value).errors),
        },
        common: {
            name: {
                "en": "errors\n",
