 ...
 * and color can be adjusted. Additionally, the
 ...
 * - Transition Time (duration of transition effect in seconds)
 */
function addRGB(deviceObj, rgbId) {
    ...
    deviceObj[`RGBW${rgbId}.transition`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/rgbw:${rgbId}`,
 ...
 * - Switch (on/off control)
 * - Brightness (brightness level from 0 to 100)
 * - ColorRGB (RGB color in number string format)
