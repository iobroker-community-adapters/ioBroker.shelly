 ...
 */
function addPresence(deviceObj, presenceId) {
    deviceObj[`Presence${presenceId}.TiltCalibrate`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => {
                return JSON.stringify({
    ...
    deviceObj[`Presence${presenceId}.LiveTrack`] = {
        mqtt: {
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value, self) => {
                return JSON.stringify({
    ...
    deviceObj[`Presence${presenceId}.Enable`] = {
        mqtt: {
    ...
    deviceObj[`Presence${presenceId}.ZMin`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.ZMax`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorFlipped`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorHeight`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorTilt`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorPoints`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorVelocity`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorSNR`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorMaxVelocity`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorPosition`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorPower`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorSensitivity`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorStateDetActThr`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorStateDetFreeThr`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorStateActFreeThr`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorStateStatFreeThr`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.SensorStateSleepFreeThr`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.UIImperial`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.LEDsBrightness`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.NightModeEnable`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
            http_publish_funct: value => (value ? JSON.parse(value).leds?.night_mode?.enable : undefined),
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Presence${presenceId}.NightModeBrightness`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
            http_publish_funct: value => (value ? JSON.parse(value).leds?.night_mode?.brightness : undefined),
            mqtt_cmd: '<mqttprefix>/rpc',
    ...
    deviceObj[`Presence${presenceId}.MainZone`] = {
        mqtt: {
            http_publish: `/rpc/Presence.GetConfig`,
    ...
    deviceObj[`Presence${presenceId}.LiveTrackTimerStartedAt`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/presence:${presenceId}`,
            mqtt_publish_funct: value => {
    ...
    deviceObj[`Presence${presenceId}.LiveTrackTimerDuration`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/presence:${presenceId}`,
            mqtt_publish_funct: value => {
                const parsed = JSON.parse(value);
    ...
    deviceObj[`Presence${presenceId}.LiveTrackInterval`] = {
        mqtt: {
            mqtt_publish: `<mqttprefix>/status/presence:${presenceId}`,
            mqtt_publish_funct: value => {
                const parsed = JSON.parse(value);
