...
const shellypro4pm = {
    ...
    'Relay2.Switch': {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({id: 1, src: 'iobroker', method: 'Switch.Set', params: {id: 2, on: value}}); }
        },
        common: {
            'name': 'Switch',
            'type': 'boolean',
    ...
    'Relay2.ChannelName': {
        mqtt: {
            http_publish: '/rpc/Switch.GetConfig?id=2',
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({id: 0, src: 'iobroker', method: 'Switch.SetConfig', params: {id: 2, config: {name: value}}}); }
        },
        common: {
            'name': 'Channel Name',
            'type': 'string',
    ...
    'Relay3.Switch': {
        mqtt: {
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({id: 1, src: 'iobroker', method: 'Switch.Set', params: {id: 3, on: value}}); }
        },
        common: {
            'name': 'Switch',
            'type': 'boolean',
    ...
    'Relay3.ChannelName': {
        mqtt: {
            http_publish: '/rpc/Switch.GetConfig?id=3',
            ...
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({id: 0, src: 'iobroker', method: 'Switch.SetConfig', params: {id: 3, config: {name: value}}}); }
        },
        common: {
            'name': 'Channel Name',
            'type': 'string',
