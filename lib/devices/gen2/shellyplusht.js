...
const shellyplusht = {
    'HTUI.DisplayUnit': {
        mqtt: {
            ...
            http_publish_funct: (value) => { return value ? JSON.parse(value).temperature_unit : undefined; },
            mqtt_cmd: '<mqttprefix>/rpc',
            mqtt_cmd_funct: (value) => { return JSON.stringify({ id: 0, src: 'iobroker', method: 'HT_UI.SetConfig', params: { config: { temperature_unit: value } }}); },
        },
        common: {
            name: {
                en: 'Unit on display',
...
shellyHelperGen2.addDevicePowerToGen2Device(shellyplusht, 0);
