 ...
 * @param id
 * @param access ('crw', 'cr', ...)
 * @param additionalCommon (optional) - Object with additional properties to add to the .Value common object
 */
function addBoolean(deviceObj, id, access, additionalCommon) {
 ...
 * @param additionalCommon (optional) - Object with additional properties to add to the .Value common object
 */
function addButton(deviceObj, id, _access, additionalCommon) {
 ...
 * @param additionalCommon (optional) - Object with additional properties to add to the .Value common object
 */
function addNumber(deviceObj, id, access, additionalCommon) {
    // const isReadable = access.includes('r');
    const isWriteable = access.includes('w');
