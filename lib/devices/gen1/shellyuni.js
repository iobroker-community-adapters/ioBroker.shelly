...
const shellyuni = {
    ...
    'ext.temperatureOffsetC1': {
        coap: {
            ...
            http_publish_funct: (value) => { return value ? JSON.parse(value)[0]?.offset_tC : undefined; },
            http_cmd: '/settings/ext_temperature/0',
            http_cmd_funct: (value) => { return { offset_tC: value }; },
        },
        mqtt: {
            http_publish: '/settings/ext_temperature/0',
            http_publish_funct: (value) => { return value ? JSON.parse(value)[0]?.offset_tC : undefined; },
    ...
    'ext.temperatureOffsetF1': {
        coap: {
            http_publish: '/settings/ext_temperature/0',
            http_publish_funct: (value) => { return value ? JSON.parse(value)[0]?.offset_tF : undefined; },
            http_cmd: '/settings/ext_temperature/0',
            http_cmd_funct: (value) => { return { offset_tF: value }; },
        },
        mqtt: {
            http_publish: '/settings/ext_temperature/0',
            http_publish_funct: (value) => { return value ? JSON.parse(value)[0]?.offset_tF : undefined; },
