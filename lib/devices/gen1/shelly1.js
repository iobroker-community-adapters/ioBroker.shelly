...
const shelly1 = {
    'Relay0.Switch': {
        coap: {
            ...
            http_cmd: '/relay/0',
            http_cmd_funct: async (value, self) => value === true ? { turn: 'on', timer: await shellyHelper.getSetDuration(self, 'Relay0.Timer') } : { turn: 'off', timer: await shellyHelper.getSetDuration(self, 'Relay0.Timer') },
        },
        mqtt: {
