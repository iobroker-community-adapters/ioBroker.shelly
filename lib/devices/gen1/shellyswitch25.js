...
const shellyswitch25 = {
    ...
    'Favorites.Position1': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position1Pos') }),
        },
        mqtt: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position1Pos') }),
    ...
    'Favorites.Position2': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position2Pos') }),
        },
        mqtt: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position2Pos') }),
    ...
    'Favorites.Position3': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position3Pos') }),
        },
        mqtt: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position3Pos') }),
    ...
    'Favorites.Position4': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position4Pos') }),
        },
        mqtt: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': await shellyHelper.getFavoritePosition(self, 'Favorites.Position4Pos') }),
