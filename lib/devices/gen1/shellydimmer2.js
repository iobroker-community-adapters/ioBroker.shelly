...
const shellydimmer2 = {
    ...
    'lights.brightness': {
        ...
        mqtt: {
            ...
            mqtt_cmd_funct: (value) => { return value >= 0 ? JSON.stringify({ brightness: Math.round(value) }) : undefined; },
        },
        common: {
            name: 'Brightness',
            type: 'number',
    ...
    'lights.Transiton': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: (value) => { return value ? JSON.parse(value).transition : undefined; },
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: (value) => { return value ? JSON.parse(value).transition : undefined; },
    ...
    'lights.FadeRate': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: (value) => { return value ? JSON.parse(value).fade_rate : undefined; },
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: (value) => { return value ? JSON.parse(value).fade_rate : undefined; },
