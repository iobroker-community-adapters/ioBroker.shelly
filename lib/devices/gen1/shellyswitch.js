...
const shellyswitch = {
    ...
    'Shutter.Close': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ go: 'close', duration: await shellyHelper.getSetDuration(self, 'Shutter.Duration', 0) }),
        },
        mqtt: {
    ...
    'Shutter.Open': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ go: 'open', duration: await shellyHelper.getSetDuration(self, 'Shutter.Duration', 0) }),
        },
        mqtt: {
            mqtt_cmd: 'shellies/<mqttprefix>/roller/0/command',
            mqtt_cmd_funct: () => 'open',
    ...
    'Shutter.Pause': {
        coap: {
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ go: 'stop', duration: await shellyHelper.getSetDuration(self, 'Shutter.Duration', 0) }),
        },
        mqtt: {
            mqtt_cmd: 'shellies/<mqttprefix>/roller/0/command',
            mqtt_cmd_funct: () => 'stop',
    ...
    'Shutter.Position': {
        coap: {
            ...
            http_cmd: '/roller/0',
            http_cmd_funct: async (value, self) => ({ 'go': 'to_pos', 'roller_pos': value, 'duration': await shellyHelper.getSetDuration(self, 'Shutter.Duration', 0) }),
        },
        mqtt: {
