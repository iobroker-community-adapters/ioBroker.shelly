...
const shellytrv = {
    'bat.value': {
        ...
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).bat.value : 0,
        },
        common: {
            name: {
                en: 'Battery capacity',
    ...
    'bat.voltage': {
        coap: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).bat.voltage : 0,
        },
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).bat.voltage : 0,
    ...
    'bat.charger': {
        coap: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).charger : false,
        },
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).charger : false,
    ...
    'tmp.temperatureSensorWorking': {
        ...
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].tmp.is_valid : undefined,
        },
        common: {
    ...
    'tmp.temperatureTargetC': {
        coap: {
            ...
            http_cmd_funct: value => ({ target_t: value }),
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].target_t.value : undefined,
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ target_t: value }),
        },
        common: {
    ...
    'tmp.temperatureTargetF': {
        coap: {
            coap_publish: '3104',
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ target_t: shellyHelper.fahrenheitToCelsius(value) }),
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: value => value ? shellyHelper.celsiusToFahrenheit(JSON.parse(value).thermostats[0].target_t.value) : undefined,
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ target_t: shellyHelper.fahrenheitToCelsius(value) }),
        },
        common: {
    ...
    'tmp.temperatureOffset': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].temperature_offset : undefined,
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ temperature_offset: value }),
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].temperature_offset : undefined,
    ...
    'tmp.automaticTemperatureControl': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: (value) => { return value ? JSON.parse(value).thermostats[0].t_auto.enabled : undefined; },
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: (value) => { return { t_auto_enabled: value }; },
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: (value) => { return value ? JSON.parse(value).thermostats[0].t_auto.enabled : undefined; },
        ...
        common: {
            name: 'Enable Temperature controlled Valve (t_auto)',
            type: 'boolean',
            role: 'switch',
            read: true,
            write: true,
    ...
    'tmp.valvePosition': {
        coap: {
            coap_publish: '3121',
            coap_publish_funct: (value) => { return value ? JSON.parse(value).thermostats[0].pos : undefined; },
            http_cmd: '/thermostat/0',
            http_cmd_funct: (value) => { return { pos: value }; },
        },
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].pos : undefined,
            http_cmd: '/thermostat/0',
            http_cmd_funct: (value) => { return { pos: value }; },
        },
        common: {
    ...
    'ext.enabled': {
        coap: {
            http_publish: '/settings',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].ext_t.enabled : undefined,
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ ext_t_enabled: value ? 1 : 0 }),
        },
        mqtt: {
            http_publish: '/settings',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].ext_t.enabled : undefined,
    ...
    'ext.openWindow': {
        coap: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].window_open : undefined,
            http_cmd: '/window',
            http_cmd_funct: value => ({ state: value ? 'open' : 'close' }),
        },
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].window_open : undefined,
    ...
    'schedule.schedule': {
        coap: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].schedule : undefined,
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ schedule: value }),
        },
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].schedule : undefined,
    ...
    'schedule.profile': {
        coap: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].schedule_profile : undefined,
            http_cmd: '/settings/thermostat/0',
    ...
    'boost.timeRemaining': {
        ...
        mqtt: {
            http_publish: '/status',
            http_publish_funct: value => value ? JSON.parse(value).thermostats[0].boost_minutes : undefined,
        },
        common: {
    ...
    'boost.setDuration': {
        coap: {
            ...
            http_publish_funct: value => value ? JSON.parse(value).boost_minutes : undefined,
            http_cmd: '/settings/thermostat/0',
            http_cmd_funct: value => ({ boost_minutes: value }),
        },
        mqtt: {
            http_publish: '/settings/thermostat/0',
            http_publish_funct: value => value ? JSON.parse(value).boost_minutes : undefined,
    ...
    'boost.start': {
        coap: {
            http_cmd: '/thermostat/0',
            http_cmd_funct: async (value, self) => ({ boost_minutes: await shellyHelper.getSetDuration(self, 'boost.setDuration') }),
        },
        mqtt: {
            http_cmd: '/thermostat/0',
            http_cmd_funct: async (value, self) => ({ boost_minutes: await shellyHelper.getSetDuration(self, 'boost.setDuration') }),
    ...
    'boost.stop': {
        coap: {
            http_cmd: '/thermostat/0',
            http_cmd_funct: () => ({ boost_minutes: 0 }),
        },
        mqtt: {
            http_cmd: '/thermostat/0',
            http_cmd_funct: () => ({ boost_minutes: 0 }),
