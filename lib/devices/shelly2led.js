...
let shelly2led = {
  'lights.Switch': {
    coap: {
      coap_publish_funct: (value) => { return value.G[4][2] === 1 ? true : false; },
      http_cmd: '/color/0',
      http_cmd_funct: (value) => { return value === true ? { turn: 'on' } : { turn: 'off' }; },
    },
    mqtt: {
      mqtt_publish: 'shellies/shelly2led-<deviceid>/color/0',
      mqtt_publish_funct: (value) => { return value === 'on'; },
      mqtt_cmd: 'shellies/shelly2led-<deviceid>/color/0/command',
  ...
  'lights.mode': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly2led-<deviceid>/color/0/status',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).mode : undefined; },
      mqtt_cmd: 'shellies/shelly2led-<deviceid>/color/0/set',
