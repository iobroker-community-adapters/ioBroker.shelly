...
let shelly4pro = {
  ...
  'Relay0.Energy': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/relay/0/energy',
  ...
  'Relay0.Input': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/input/0',
  ...
  'Relay1.Energy': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/relay/1/energy',
      mqtt_publish_funct: (value) => { return Math.round((value / 60) * 100) / 100; }
    },
    common: {
      'name': 'Energy',
  ...
  'Relay1.Input': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/input/1',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; }
    },
    common: {
      'name': 'Input / Detach',
  ...
  'Relay2.ChannelName': {
    coap: {
      ...
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setChannelName(self, 'Relay2.ChannelName', JSON.parse(value).relays[2].name) : undefined; },
  ...
  'Relay2.Energy': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/relay/2/energy',
      mqtt_publish_funct: (value) => { return Math.round((value / 60) * 100) / 100; }
    },
    common: {
      'name': 'Energy',
  ...
  'Relay2.Input': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/input/2',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; }
    },
    common: {
      'name': 'Input / Detach',
  ...
  'Relay3.ChannelName': {
    coap: {
      ...
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setChannelName(self, 'Relay3.ChannelName', JSON.parse(value).relays[3].name) : undefined; },
  ...
  'Relay3.Energy': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/relay/3/energy',
      mqtt_publish_funct: (value) => { return Math.round((value / 60) * 100) / 100; }
    },
    common: {
      'name': 'Energy',
  ...
  'Relay3.Input': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly4pro-<deviceid>/input/3',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; }
    },
    common: {
      'name': 'Input / Detach',
