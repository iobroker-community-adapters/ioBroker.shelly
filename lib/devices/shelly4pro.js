...
let shelly4pro = {
  ...
  'Relay2.ChannelName': {
    coap: {
      ...
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setDeviceName(self, 'Relay2.ChannelName', JSON.parse(value).relays[2].name) : undefined; },
  ...
  'Relay3.ChannelName': {
    coap: {
      ...
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setDeviceName(self, 'Relay3.ChannelName', JSON.parse(value).relays[3].name) : undefined; },
