...
//      http_cmd: '/status/inputs',
//      http_cmd_funct: (value) => { return { event: value }; }
...
//      http_cmd_funct: (value) => { return { event: value }; }
  ...
  'Relay0.eventcnt': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/eventcnt/0',
      mqtt_publish_funct: (value) => { return value ; },
    },
    common: {
      'name': 'inputEventCnt',
  ...
  'overpower': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyplug-s-<deviceid>/overpower',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; },
    },
    common: {
      'name': 'Overpower',
  ...
  'overpowerValue': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyplug-s-<deviceid>/overpowerValue',
    },
    common: {
