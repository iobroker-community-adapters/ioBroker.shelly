...
let shelly1pm = {
  ...
  'ext.humidity1': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? getExtHum(JSON.parse(value), '0') : undefined; }
    },
    mqtt: {
  ...
  'ext.humidity2': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? getExtHum(JSON.parse(value), '1') : undefined; }
    },
    mqtt: {
  ...
  'ext.humidity3': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? getExtHum(JSON.parse(value), '2') : undefined; }
    },
    mqtt: {
  ...
  'ext.humidity4': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? getExtHum(JSON.parse(value), '3') : undefined; }
    },
    mqtt: {
