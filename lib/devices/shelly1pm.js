...
let shelly1pm = {
  ...
  'Relay0.Event': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/input_event/0',
  ...
  'Relay0.longpushtime': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/longpushtime/0',
      http_publish_funct: (value) => { return value ? JSON.parse(value).longpush_time : undefined; },
      http_cmd: '/settings',
      http_cmd_funct: (value) => { return { longpush_time: value }; }
    },
  ...
  'overtemperature': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/overtemperature',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; },
    },
    common: {
      'name': 'Temperature',
  ...
  'overpower': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/overpower',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; },
    },
    common: {
      'name': 'Overpower',
  ...
  'overpowerValue': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/overpowerValue',
    },
    common: {
