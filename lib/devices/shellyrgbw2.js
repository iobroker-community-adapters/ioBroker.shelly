...
let shellyrgbw2 = {
  ...
  'color.effect': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).lights.effect : undefined; },
      http_cmd: '/color/0',
  ...
  'white1.ButtonType': {
    coap: {
      ...
      http_publish_funct: (value) => { return value ? JSON.parse(value).lights[1].btn_type : undefined; },
      http_cmd_funct: (value) => { return { btn_type: value }; }
    },
    mqtt: {
      http_publish: '/settings',
  ...
  'white2.ButtonType': {
    coap: {
      ...
      http_publish_funct: (value) => { return value ? JSON.parse(value).lights[2].btn_type : undefined; },
      http_cmd_funct: (value) => { return { btn_type: value }; }
    },
    mqtt: {
      http_publish: '/settings',
  ...
  'white3.ButtonType': {
    coap: {
      ...
      http_publish_funct: (value) => { return value ? JSON.parse(value).lights[3].btn_type : undefined; },
      http_cmd_funct: (value) => { return { btn_type: value }; }
    },
    mqtt: {
      http_publish: '/settings',
  ...
  'meters.Power4': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? (Math.round(JSON.parse(value).meters[3].power * 100) / 100) : undefined; }
    },
    mqtt: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? (Math.round(JSON.parse(value).meters[3].power * 100) / 100) : undefined; }
