...
let shelly3em = {
  ...
  'Emeter1.Total': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyem-<deviceid>/emeter/1/total',
      mqtt_publish_funct: (value) => { return (Math.round(value * 100) / 100); }
    },
    common: {
      'name': 'Total',
  ...
  'Emeter1.Total_Returned': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyem-<deviceid>/emeter/1/total_returned',
      mqtt_publish_funct: (value) => { return (Math.round(value * 100) / 100); }
    },
    common: {
      'name': 'Total_Returned',
  ...
  'Emeter2.Power': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyem-<deviceid>/emeter/2/power',
      mqtt_publish_funct: (value) => { return (Math.round(value * 100) / 100); }
    },
    common: {
      'name': 'Power',
  ...
  'Emeter2.Total': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyem-<deviceid>/emeter/2/total',
      mqtt_publish_funct: (value) => { return (Math.round(value * 100) / 100); }
    },
    common: {
      'name': 'Total',
  ...
  'Emeter2.Total_Returned': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyem-<deviceid>/emeter/2/total_returned',
      mqtt_publish_funct: (value) => { return (Math.round(value * 100) / 100); }
    },
    common: {
      'name': 'Total_Returned',
  ...
  'Emeter2.Voltage': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyem-<deviceid>/emeter/2/voltage',
      mqtt_publish_funct: (value) => { return (Math.round(value * 100) / 100); }
    },
    common: {
      'name': 'Voltage',
