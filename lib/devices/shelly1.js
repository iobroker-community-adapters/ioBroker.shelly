...
let shelly1 = {
  ...
  'ext.humidity1': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/ext_humidities',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value)['0'].hum : undefined; },
    },
    common: {
  ...
  'ext.humidity2': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/ext_humidities/1',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).hum : undefined; },
    },
    common: {
      'name': 'External Humidity',
      'type': 'number',
  ...
  'ext.humidity3': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/ext_humidities/2',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).hum : undefined; },
    },
    common: {
      'name': 'External Humidity',
  ...
  'ext.humidity4': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1pm-<deviceid>/ext_humidities/3',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).hum : undefined; },
    },
    common: {
      'name': 'External Humidity',
