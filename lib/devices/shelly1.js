...
let shelly1 = {
  ...
  'ext.humidity1': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1-<deviceid>/ext_humidity/0',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
  ...
  'ext.humidity2': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1-<deviceid>/ext_humidity/1',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Humidity',
  ...
  'ext.humidity3': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shelly1-<deviceid>/ext_humidity/2',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Humidity',
