...
let shelly1 = {
  ...
  'ext.temperatureC1': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['0'].tC : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureC2': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['1'].tC : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureC3': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['2'].tC : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureC4': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['3'].tC : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureF1': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['0'].tF : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureF2': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['1'].tF : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureF3': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['2'].tF : undefined; },
    },
    mqtt: {
  ...
  'ext.temperatureF4': {
    coap: {
      http_publish: '/status',
      http_publish_funct: (value) => { return value ? JSON.parse(value).ext_temperature['3'].tF : undefined; },
    },
    mqtt: {
