...
let shellyswitch25 = {
  ...
  'Relay0.ChannelName': {
    coap: {
      ...
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setChannelName(self, 'Relay0.ChannelName', JSON.parse(value).relays[0].name) : undefined; },
  ...
  'Relay0.Event': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/input_event/0',
  ...
  'Relay1.ChannelName': {
    coap: {
      http_publish: '/settings',
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setChannelName(self, 'Relay1.ChannelName', JSON.parse(value).relays[1].name) : undefined; },
  ...
  'Relay1.Event': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/input_event/1',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).event : undefined; }
    },
    common: {
      'name': 'Event',
  ...
  'Shutter.Energy': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/roller/0/energy ',
      mqtt_publish_funct: (value) => { return (Math.round((value / 60) * 100) / 100); }
    },
    common: {
      'name': 'Energy',
  ...
  'overtemperature': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/overtemperature',
      mqtt_publish_funct: (value) => { return value == 1 ? true : false; },
    },
    common: {
      'name': 'Temperature',
  ...
  'ext.temperatureC1': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature/0',
  ...
  'ext.temperatureC2': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature/1',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
  ...
  'ext.temperatureC3': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature/2',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
  ...
  'ext.temperatureC4': {
    ...
    mqtt: {
      no_display: true // CoAP >= 1.8
      //mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature/3',
      //mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
  ...
  'ext.temperatureF1': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature_f/0',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
  ...
  'ext.temperatureF2': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature_f/1',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
  ...
  'ext.temperatureF3': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature_f/2',
      mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
  ...
  'ext.temperatureF4': {
    ...
    mqtt: {
      no_display: true // CoAP >= 1.8
      //mqtt_publish: 'shellies/shellyswitch25-<deviceid>/ext_temperature_f/3',
      //mqtt_publish_funct: (value) => { return String(value).replace(/[^0-9\.]/g, ''); }
    },
    common: {
      'name': 'External Temperature',
