...
let shellyswitch25 = {
  ...
  'Relay0.ChannelName': {
    coap: {
      ...
      http_publish_funct: (value) => { return value ? JSON.parse(value).relays[0].name : undefined; },
  ...
  'Relay1.ChannelName': {
    coap: {
      http_publish: '/settings',
      http_publish_funct: (value) => { return value ? JSON.parse(value).relays[1].name : undefined; },
