...
let shellydimmer = {
  ...
  'lights.ChannelName': {
    coap: {
      ...
      http_publish_funct: async (value, self) => { return value ? await shellyHelper.setChannelName(self, 'lights.ChannelName', JSON.parse(value).lights[0].name) : undefined; },
  ...
  'lights.Event1': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellydimmer-<deviceid>/input_event/0',
  ...
  'lights.Event2': {
    ...
    mqtt: {
      mqtt_publish: 'shellies/shellydimmer-<deviceid>/input_event/1',
      mqtt_publish_funct: (value) => { return value ? JSON.parse(value).event : undefined; }
    },
    common: {
      'name': 'Event',
