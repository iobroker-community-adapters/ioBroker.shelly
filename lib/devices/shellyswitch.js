...
let shellyswitch = {
  ...
  'Shutter.Open': {
    coap: {
      ...
      http_cmd: '/roller/0',
      http_cmd_funct: async (value, self) => { return { go: 'open', duration: await shuterDuration(self) }; },
    },
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch-<deviceid>/roller/0',
  ...
  'Shutter.Pause': {
    coap: {
      ...
      http_cmd: '/roller/0',
      http_cmd_funct: async (value, self) => { return { go: 'stop', duration: await shuterDuration(self) }; }
    },
    mqtt: {
      mqtt_publish: 'shellies/shellyswitch-<deviceid>/roller/0',
      mqtt_cmd: 'shellies/shellyswitch-<deviceid>/roller/0/command',
  ...
  'Shutter.Position': {
    coap: {
      ...
      http_cmd: '/roller/0',
      http_cmd_funct: async (value, self) => { return { 'go': 'to_pos', 'roller_pos': value, 'duration': await shuterDuration(self) }; }
    },
    mqtt: {
