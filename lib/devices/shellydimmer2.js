...
let shellydimmer2 = {
  ...
  'lights.Input1': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: async (value, self) => { if (value === 0) { shellyHelper.setValueForId(self, 'lights1.longpush1', false); return false; } else { return true; } }
    },
    common: {
      'name': 'Input / Detach',
      'type': 'boolean',
  ...
  'lights.Input2': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: async (value, self) => { if (value === 0) { shellyHelper.setValueForId(self, 'lights1.longpush2', false); return false; } else { return true; } }
    },
    common: {
      'name': 'Input / Detach',
      'type': 'boolean',
