...
let shellydimmer2 = {
  ...
  'lights.Input1': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: async (value, self) => { if (value === 1) { return true; } else {  shellyHelper.setValueForId(self, 'lights.longpush1', false); return false; } }
    },
    common: {
      'name': 'Input / Detach',
      'type': 'boolean',
  ...
  'lights.Input2': {
    ...
    mqtt: {
      ...
      mqtt_publish_funct: async (value, self) => { if (value === 1) { return true; } else { shellyHelper.setValueForId(self, 'lights.longpush2', false); return false; } }
    },
    common: {
      'name': 'Input / Detach',
      'type': 'boolean',
